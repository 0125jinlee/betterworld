...
function color(property1, property2, validator) {
  ...
  if (
    ...
    (validator.isValidRgbaColor(color1) || validator.isValidHslaColor(color1))
  )
    return false;
  if (
    !validator.colorOpacity &&
    (validator.isValidRgbaColor(color2) || validator.isValidHslaColor(color2))
  )
    return false;
...
function twoOptionalFunctions(property1, property2, validator) {
  ...
  return !(
    validator.isValidFunction(value1) ^ validator.isValidFunction(value2)
  );
}
...
function unit(property1, property2, validator) {
  ...
  if (
    validator.isValidAndCompatibleUnitWithoutFunction(value1) &&
    !validator.isValidAndCompatibleUnitWithoutFunction(value2)
  )
    return false;
  ...
  if (
    validator.isValidFunctionWithoutVendorPrefix(value2) &&
    validator.isValidFunctionWithoutVendorPrefix(value1)
  ) {
    return true;
  }
