...
function isInheritOnly(values) {
  for (var i = 0, l = values.length; i < l; i++) {
    ...
    if (
      value != "inherit" &&
      value != MULTIPLEX_SEPARATOR &&
      value != SIZE_POSITION_SEPARATOR
    )
      return false;
  }
  ...
  function isDefaultValue(component) {
    ...
    if (descriptor.doubleValues) {
      if (descriptor.defaultValue.length == 1)
        return (
          component.value[0][0] == descriptor.defaultValue[0] &&
          (component.value[1]
            ? component.value[1][0] == descriptor.defaultValue[0]
            : true)
        );
      else
        return (
          ...
          (component.value[1]
            ? component.value[1][0]
            : component.value[0][0]) == descriptor.defaultValue[1]
        );
    } else {
    ...
    if (component.name == "background-clip") {
      ...
      needsBoth =
        ...
        ((isOriginDefault && !isDefault) ||
          ...
          (!isOriginDefault &&
            isDefault &&
            component.value[0][0] != originComponent.value[0][0]));
  ...
  if (property.multiplex) {
    ...
    if (
      ...
      (horizontalValues.length > 1
        ? horizontalValues[1][0] == verticalValues[1][0]
        : true) &&
      (horizontalValues.length > 2
        ? horizontalValues[2][0] == verticalValues[2][0]
        : true) &&
      (horizontalValues.length > 3
        ? horizontalValues[3][0] == verticalValues[3][0]
        : true)
    ) {
