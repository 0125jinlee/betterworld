  ...
  })(
    {
        ...
        function(_dereq_, module, exports) {
          ...
          lp.parseMaybeConditional = function(noIn) {
            ...
            if (this.eat(_.tokTypes.question)) {
              ...
              node.alternate = this.expect(_.tokTypes.colon)
          ...
          lp.parseExprAtom = function() {
            ...
            switch (this.tok.type) {
              ...
              case _.tokTypes._super:
                var type =
                  this.tok.type === _.tokTypes._this
                    ? "ThisExpression"
                    : "Super";
                node = this.startNode();
                this.next();
              ...
              case _.tokTypes.name:
                ...
                return this.eat(_.tokTypes.arrow)
              ...
              case _.tokTypes._false:
                node = this.startNode();
                node.value =
                  this.tok.type === _.tokTypes._null
                    ? null
                    : this.tok.type === _.tokTypes._true;
              ...
              case _.tokTypes.parenL:
                ...
                if (this.eat(_.tokTypes.arrow)) {
                  return this.parseArrowExpression(
                    ...
                    inner.expressions ||
                      (_parseutil.isDummy(inner) ? [] : [inner])
                  );
                }
          ...
          lp.parseObj = function() {
            ...
            while (!this.closes(_.tokTypes.braceR, indent, line)) {
              ...
              if (this.eat(_.tokTypes.colon)) {
                ...
                (this.tok.type === _.tokTypes.parenL ||
                  this.tok.type === _.tokTypes.braceL)
              ) {
                prop.kind = "init";
                prop.method = true;
                ...
                this.tok.type != _.tokTypes.comma &&
                this.tok.type != _.tokTypes.braceR
              ) {
          ...
          lp.parsePropertyName = function(prop) {
            ...
            var key =
              this.tok.type === _.tokTypes.num ||
              this.tok.type === _.tokTypes.string
                ? this.parseExprAtom()
                : this.parseIdent();
        ...
        function(_dereq_, module, exports) {
          ...
          var LooseParser = (function() {
            ...
            LooseParser.prototype.isContextual = function isContextual(name) {
              return (
                this.tok.type === _.tokTypes.name && this.tok.value === name
              );
            };
            ...
            LooseParser.prototype.lineEnd = function lineEnd(pos) {
              while (
                ...
                !_.isNewLine(this.input.charCodeAt(pos))
              )
                ++pos;
              return pos;
            };

            LooseParser.prototype.indentationAfter = function indentationAfter(
              pos
            ) {
              for (var count = 0; ; ++pos) {
            ...
            LooseParser.prototype.loadPlugins = function loadPlugins(
              pluginConfigs
            ) {
        ...
        function(_dereq_, module, exports) {
          ...
          lp.parseTopLevel = function() {
            var node = this.startNodeAt(
              this.options.locations ? [0, _.getLineInfo(this.input, 0)] : 0
            );
            node.body = [];
          ...
          lp.parseStatement = function() {
            ...
            switch (starttype) {
              ...
              case _.tokTypes._do:
                ...
                node.test = this.eat(_.tokTypes._while)
              ...
              case _.tokTypes._for:
                ...
                if (
                  this.tok.type === _.tokTypes._var ||
                  this.tok.type === _.tokTypes._let ||
                  this.tok.type === _.tokTypes._const
                ) {
                  var _init = this.parseVar(true);
                  if (
                    _init.declarations.length === 1 &&
                    (this.tok.type === _.tokTypes._in ||
              ...
              case _.tokTypes._if:
                ...
                node.alternate = this.eat(_.tokTypes._else)
                  ? this.parseStatement()
                  : null;
              ...
              case _.tokTypes._switch:
                ...
                var cur = undefined;
                while (
                  !this.closes(_.tokTypes.braceR, blockIndent, line, true)
                ) {
                  if (
                    this.tok.type === _.tokTypes._case ||
                    this.tok.type === _.tokTypes._default
                  ) {
              ...
              case _.tokTypes._try:
                ...
                node.finalizer = this.eat(_.tokTypes._finally)
                  ? this.parseBlock()
                  : null;
              ...
              default:
                ...
                if (_parseutil.isDummy(expr)) {
                  ...
                  starttype === _.tokTypes.name &&
                  expr.type === "Identifier" &&
                  this.eat(_.tokTypes.colon)
                ) {
                  node.body = this.parseStatement();
                  node.label = expr;
          ...
          lp.parseFor = function(node, init) {
            ...
            if (
              this.eat(_.tokTypes.semi) &&
              this.tok.type !== _.tokTypes.parenR
            )
            ...
            do {
              ...
              decl.id =
                this.options.ecmaVersion >= 6
                  ...
                  : this.parseIdent();
              decl.init = this.eat(_.tokTypes.eq)
                ? this.parseMaybeAssign(noIn)
                : null;
          ...
          lp.parseClass = function(isStatement) {
            ...
            node.superClass = this.eat(_.tokTypes._extends)
          ...
          lp.parseImport = function() {
            ...
            if (this.tok.type === _.tokTypes.string) {
              ...
              node.source =
                this.eatContextual("from") && this.tok.type == _.tokTypes.string
                  ? this.parseExprAtom()
                  : this.dummyString();
      ...
      7: [
        function(_dereq_, module, exports) {
          ...
          function isSpace(ch) {
            return (
              (ch < 14 && ch > 8) || ch === 32 || ch === 160 || _.isNewLine(ch)
            );
          }
          ...
          lp.readToken = function() {
            for (;;) {
              try {
                ...
                if (replace) {
                  if (this.options.locations)
                    replace.loc = new _.SourceLocation(
                      this.toks,
                      _.getLineInfo(this.input, replace.start),
                      _.getLineInfo(this.input, replace.end)
                    );
                  return replace;
                }
              }
          ...
          lp.resetTo = function(pos) {
            ...
            if (this.options.locations) {
              ...
              var match = undefined;
              while (
                (match = _.lineBreakG.exec(this.input)) &&
                match.index < pos
              ) {
                ++this.toks.curLine;
