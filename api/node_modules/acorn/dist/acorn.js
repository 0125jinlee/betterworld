      ...
      1: [
        function(_dereq_, module, exports) {
          ...
          pp.parseExprAtom = function(refDestructuringErrors) {
            ...
            switch (this.type) {
              ...
              case _tokentype.types._this:
                var type =
                  this.type === _tokentype.types._this
                    ? "ThisExpression"
                    : "Super";
                node = this.startNode();
                this.next();
              ...
              case _tokentype.types._false:
                node = this.startNode();
                node.value =
                  this.type === _tokentype.types._null
                    ? null
          ...
          pp.parsePropertyName = function(prop) {
            ...
            return (prop.key =
              this.type === _tokentype.types.num ||
          ...
          pp.parseYield = function() {
            ...
            this.next();
            if (
              this.type == _tokentype.types.semi ||
              this.canInsertSemicolon() ||
          ...
          pp.parseComprehension = function(node, isGenerator) {
            ...
            this.expect(
              isGenerator ? _tokentype.types.parenR : _tokentype.types.bracketR
            );
          ...
          function pushComment(options, array) {
            return function(block, text, start, end, startLoc, endLoc) {
              ...
              if (options.locations)
                comment.loc = new _locutil.SourceLocation(
                  this,
                  startLoc,
                  endLoc
                );
        ...
        function(_dereq_, module, exports) {
          ...
          pp.checkPatternErrors = function(refDestructuringErrors, andThrow) {
            ...
            if (pos)
              this.raise(
                pos,
                "Trailing comma is not permitted in destructuring patterns"
              );
          };
          ...
          var Parser = (function() {
            function Parser(options, input, startPos) {
              ...
              this.keywords = keywordRegexp(
                _identifier.keywords[options.ecmaVersion >= 6 ? 6 : 5]
              );
              var reserved = options.allowReserved
                ? ""
                : _identifier.reservedWords[options.ecmaVersion] +
              ...
              if (startPos) {
                ...
                this.curLine = this.input
                  ...
                  .split(_whitespace.lineBreak).length;
              } else {
      ...
      11: [
        function(_dereq_, module, exports) {
          ...
          pp.parseStatement = function(declaration, topLevel) {
            ...
            switch (starttype) {
              ...
              default:
                ...
                if (
                  starttype === _tokentype.types.name &&
          ...
          pp.parseForStatement = function(node) {
            ...
            if (
              this.type === _tokentype.types._var ||
          ...
          pp.parseSwitchStatement = function(node) {
            ...
            for (
              var cur, sawDefault = false;
              this.type != _tokentype.types.braceR;

            ) {
              if (
                this.type === _tokentype.types._case ||
          ...
          pp.parseTryStatement = function(node) {
            ...
            node.finalizer = this.eat(_tokentype.types._finally)
              ? this.parseBlock()
              : null;
          ...
          pp.parseLabeledStatement = function(node, maybeName, expr) {
            ...
            var kind = this.type.isLoop
              ? "loop"
              : this.type === _tokentype.types._switch
              ? "switch"
              : null;
          ...
          pp.parseFor = function(node, init) {
            ...
            this.expect(_tokentype.types.semi);
            node.update =
              this.type === _tokentype.types.parenR
                ? null
                : this.parseExpression();
            this.expect(_tokentype.types.parenR);
            node.body = this.parseStatement(false);
        ...
        function(_dereq_, module, exports) {
          ...
          pp.skipBlockComment = function() {
            ...
            if (this.options.locations) {
              ...
              var match = undefined;
              while (
                (match = _whitespace.lineBreakG.exec(this.input)) &&
          ...
          pp.readToken_mult_modulo = function(code) {
            ...
            return this.finishOp(
              code === 42 ? _tokentype.types.star : _tokentype.types.modulo,
              1
            );
          };
          ...
          pp.readToken_eq_excl = function(code) {
            ...
            return this.finishOp(
              code === 61 ? _tokentype.types.eq : _tokentype.types.prefix,
              1
            );
          };
