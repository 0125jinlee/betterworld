...
exports.uglify = exports.uglifyJS = exports["uglify-js"] = new Transformer({
  ...
  sync: function(str, options) {
    ...
    return (
      this.cache(options) ||
      this.cache(options, uglifyJS.minify(str, options).code)
    );
  }
});
...
exports.uglifyCSS = exports["uglify-css"] = new Transformer({
  ...
  sync: function(str, options) {
    ...
    return (
      this.cache(options) ||
      this.cache(options, uglifyCSS.stringify(uglifyCSS.parse(str), options))
    );
  }
});
...
function sync(str, options) {
  var tmpl =
    this.cache(options) ||
    this.cache(options, this.engine.compile(str, options));
  return tmpl(options);
}
...
exports.dot = new Transformer({
  ...
  sync: function sync(str, options) {
    var tmpl =
      this.cache(options) || this.cache(options, this.engine.template(str));
    return tmpl(options);
  }
});
...
exports.walrus = new Transformer({
  ...
  sync: function(str, options) {
    var tmpl =
      this.cache(options) || this.cache(options, this.engine.parse(str));
...
exports.mustache = new Transformer({
  ...
  sync: function(str, options) {
    var tmpl =
      this.cache(options) || this.cache(options, this.engine.compile(str));
...
exports.just = new Transformer({
  ...
  async: function(str, options, cb) {
    ...
    var tmpl =
      this.cache(options) ||
      this.cache(options, new JUST({ root: { page: str } }));
...
exports.ect = new Transformer({
  ...
  async: function(str, options, cb) {
    ...
    var tmpl =
      this.cache(options) ||
      this.cache(options, new ECT({ root: { page: str } }));
    tmpl.render("page", options, cb);
  }
});
...
exports.jade = new Transformer({
  ...
  outputFormat: "xml",
  sudoSync:
    "The jade file FILENAME could not be rendered syncronously.  N.B. then-jade does not support syncronous rendering.",
  async: function(str, options, cb) {
...
exports.dust = new Transformer({
  ...
  async: function(str, options, cb) {
    ...
    var tmpl =
      this.cache(options) || this.cache(options, this.engine.compileFn(str));
...
exports.less = new Transformer({
  ...
  outputFormat: "css",
  sudoSync:
    "The less file FILENAME could not be rendered syncronously.  This is usually because the file contains `@import url` statements.",
  async: function(str, options, cb) {
    var self = this;
    ...
    parser.parse(str, function(err, tree) {
      try {
        ...
        if (ex.constructor.name === "LessError" && typeof ex === "object") {
          ...
          var err = new Error(
            self.engine.formatError(ex, options).replace(/^[^:]+:/, ""),
            ex.filename,
            ex.line
          );
          err.name = ex.type;
...
exports.sass = new Transformer({
  ...
  sync: function(str, options) {
    try {
      return (
        this.cache(options) || this.cache(options, this.engine.render(str))
      );
    } catch (ex) {
...
exports.md = exports.markdown = new Transformer({
  ...
  sync: function(str, options) {
    ...
    return (
      this.cache(options) || this.cache(options, this.engine.parse(str, arg))
    );
  }
});

exports.coffee = exports[
  "coffee-script"
] = exports.coffeescript = exports.coffeeScript = new Transformer({
  name: "coffee-script",
...
exports.cson = new Transformer({
  ...
  sync: function(str, options) {
    ...
    return (
      this.cache(options) ||
      this.cache(options, JSON.stringify(this.engine.parseSync(str)))
    );
  }
});
...
exports.cdata = new Transformer({
  ...
  sync: function(str, options) {
    ...
    return (
      this.cache(options) || this.cache(options, "<![CDATA[" + escaped + "]]>")
    );
  }
});
...
exports.component = exports["component-js"] = new Transformer({
  ...
  async: function(str, options, cb) {
    ...
    if (
      options.sourceURLs === true ||
      (options.sourceURLs !== false && options.development)
    ) {
...
exports["html2jade"] = new Transformer({
  ...
  async: function(str, options, cb) {
    return (
      this.cache(options) ||
      this.cache(options, this.engine.convertHtml(str, options, cb))
    );
  }
});
  ...
  sync: function(str, options, cb) {
    ...
    if (options.lang) {
      try {
        return this.cache(
          options,
          this.engine.highlight(options.lang, str).value
        );
      } catch (ex) {}
    }
