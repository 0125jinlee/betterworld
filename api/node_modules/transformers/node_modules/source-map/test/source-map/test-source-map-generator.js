...
define(function(require, exports, module) {
  ...
  exports["test applySourceMap throws when file is missing"] = function(
    assert,
    util
  ) {
    var map = new SourceMapGenerator({
  ...
  exports["test applySourceMap name handling"] = function(assert, util) {
    ...
    var assertName = function(coffeeName, jsName, expectedName) {
      ...
      new SourceMapConsumer(minifiedMap.toJSON()).eachMapping(function(
        mapping
      ) {
  ...
  exports["test sorting with duplicate generated mappings"] = function(
    assert,
    util
  ) {
    var map = new SourceMapGenerator({
