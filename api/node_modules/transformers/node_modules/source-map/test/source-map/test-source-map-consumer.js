...
define(function(require, exports, module) {
  ...
  exports["test allGeneratedPositionsFor for line with no mappings"] = function(
    assert,
    util
  ) {
    var map = new SourceMapGenerator({
  ...
  exports[
    "test allGeneratedPositionsFor source map with no mappings"
  ] = function(assert, util) {
    var map = new SourceMapGenerator({
      file: "generated.js"
    });
  ...
  exports["test absolute path, but same host sources"] = function(
    assert,
    util
  ) {
    var map = new SourceMapGenerator({
