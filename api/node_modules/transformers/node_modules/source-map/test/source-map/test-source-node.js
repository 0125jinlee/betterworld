...
define(function(require, exports, module) {
  var SourceMapGenerator = require("../../lib/source-map/source-map-generator")
    .SourceMapGenerator;
  var SourceMapConsumer = require("../../lib/source-map/source-map-consumer")
    .SourceMapConsumer;
  ...
  exports["test .toStringWithSourceMap()"] = forEachNewline(function(
    assert,
    util,
    nl
  ) {
  ...
  exports["test .fromStringWithSourceMap() third argument"] = function(
    assert,
    util
  ) {
    ...
    coffeeBundle.add(
      new SourceNode(3, 0, "http://www.example.com/baz.coffee", "baz(coffee);")
    );
  ...
  ] = forEachNewline(function(assert, util, nl) {
    var input = new SourceNode(null, null, null, [
  ...
  exports["test .toStringWithSourceMap() with empty string"] = function(
    assert,
    util
  ) {
  ...
  exports["test setSourceContent with toStringWithSourceMap"] = function(
    assert,
    util
  ) {
