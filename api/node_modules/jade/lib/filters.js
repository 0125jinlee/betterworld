      ...
      if (!warned[name]) {
        ...
        if (name === "md" || name === "markdown") {
          ...
          console.log(
            "Transformers." +
              name +
              " is deprecated, you must replace the :" +
              name +
              " jade filter, with :" +
              implementation +
              " and install jstransformer-" +
              implementation +
              " before you update to jade@2.0.0."
          );
          ...
          console.log(
            "Transformers." +
              name +
              " is deprecated, to continue using the :" +
              name +
              " jade filter after jade@2.0.0, you will need to install jstransformer-" +
              name.toLowerCase() +
              "."
          );
        }
